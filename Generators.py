...
def alcatel_filter_generator(filter_number, name, acl_vars_array, entry_number):
    ...
    """
    alcatel_vars_fixer(name, acl_vars_array)
    ...
    entry_generator(acl_vars_array, entry_number)
...
def entry_generator(acl_vars_array, entry_number):
    """
...
def alcatel_vars_fixer(name, acl_vars_array):
    """
